...
function add(dirtyDate, duration) {
  ...
  const date = toDate(dirtyDate);
  const dateWithMonths = months2 || years ? addMonths(date, months2 + years * 12) : date;
...
function format(dirtyDate, formatStr, options) {
  ...
  const defaultOptions2 = getDefaultOptions();
  const locale2 = (_b = (_a = options == null ? void 0 : options.locale) != null ? _a : defaultOptions2.locale) != null ? _b : defaultLocale_default;
...
function parse(dateString, formatString, dirtyReferenceDate, options) {
  ...
  const locale2 = (_b = (_a = options == null ? void 0 : options.locale) != null ? _a : defaultOptions2.locale) != null ? _b : en_US_default;
  if (!locale2.match) {
  ...
  const tokens = formatString.match(longFormattingTokensRegExp2).map((substring) => {
    const firstCharacter = substring[0];
